      ...
      <Routes >
        <Route path="/" element={<div>
          <div className="h-full w-full">
            <div style={{ height: "85vh" }} className="flex flex-wrap justify-center mt-4">
              <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/3 xl:w-1/3 p-4">
                <button className="w-full h-full bg-inaoe_comp2 hover:bg-opacity-80 text-center font-bold rounded-lg flex flex-col"
                onClick={()=>navigate("/solarCell")}>
                  <span className="flex-1 flex items-center justify-center text-white text-xl flex-col gap-y-10">
                    Celda Solar
                    <img className="w-1/3" src={solarCellIcon} alt="solar-cell-icon" />
                  </span>
                </button>
              </div>
              <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/3 xl:w-1/3 p-4">
                ...
                <span className="flex-1 flex items-center justify-center text-white text-xl flex-col gap-y-10">
                    MOSFET
                    <img className="w-1/3" src={mosfetIcon} alt="mosfet-icon" />
                  </span>
                </button>
              </div>

              <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/3 xl:w-1/3 p-4">
                <button className="w-full h-full bg-inaoec1 hover:bg-opacity-80 text-center font-bold rounded-lg flex flex-col">
                <span className="flex-1 flex items-center justify-center text-white text-xl flex-col gap-y-10">
